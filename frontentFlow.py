...
if st.session_state.processing_complete:
    ...
    with tabs[0]:
        ...
        if compliance_score > 80 and eligibility_score > 80 and isinstance(risk_level, str) and risk_level.lower() in ["low", "medium-low"]:
            overall_recommendation = "Recommended to Proceed"
            card_class = "success"
        elif compliance_score < 60 or eligibility_score < 60 or (isinstance(risk_level, str) and risk_level.lower() in ["high", "critical"]):
